...
def main():
    ...
    with open(os.path.join(result_dir, "evaluation_metrics.json"), "w", encoding="utf-8") as f:
        json.dump(metric_values, f, indent=2, ensure_ascii=False)
    with open(os.path.join(result_dir, "sample_predictions.json"), "w", encoding="utf-8") as f:
