...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Manage 8_ interest-summary experiment jobs.")
    parser.add_argument("--config", type=str, default=os.path.join(SCRIPT_DIR, "experiment_config.yaml"))
...
def build_jobs(config_path: str, cfg: dict) -> List[dict]:
    ...
    return [
        {
            "name": "prepare_interest_data",
            "deps": [],
            "ready_path": os.path.join(data_dir, "test_interest_common_4385.jsonl"),
            "cmd": [py, "prepare_interest_augmented_data.py", "--config", config_path],
            "log_dir": logs_dir,
            "use_gpu": False,
        },
        {
            "name": "eval_base_raw",
            "deps": ["prepare_interest_data"],
            "ready_path": os.path.join(results_dir, "base_raw_common4385_metrics.json"),
            "cmd": [
                py,
                "evaluate_interest_augmented.py",
                "--track_name",
                "base_init",
                "--config",
                config_path,
        ...
        {
            "name": "eval_base_interest",
            "deps": ["prepare_interest_data"],
            "ready_path": os.path.join(results_dir, "base_interest_common4385_metrics.json"),
            "cmd": [
                py,
                "evaluate_interest_augmented.py",
                "--track_name",
                ...
                config_path,
                "--test_path",
                os.path.join(data_dir, "test_interest_common_4385.jsonl"),
                "--output_name",
                "base_interest_common4385",
            ],
            "log_dir": logs_dir,
            "use_gpu": True,
        },
        {
            "name": "eval_strong_raw",
            "deps": ["prepare_interest_data"],
            "ready_path": os.path.join(results_dir, "strong_raw_common4385_metrics.json"),
            "cmd": [
                py,
                "evaluate_interest_augmented.py",
                "--track_name",
                ...
                os.path.join(data_dir, "test_raw_common_4385.jsonl"),
                "--output_name",
                "strong_raw_common4385",
            ],
            "log_dir": logs_dir,
            "use_gpu": True,
        },
        {
            "name": "eval_strong_interest",
            "deps": ["prepare_interest_data"],
            "ready_path": os.path.join(results_dir, "strong_interest_common4385_metrics.json"),
            "cmd": [
                py,
                "evaluate_interest_augmented.py",
                "--track_name",
                ...
                os.path.join(data_dir, "test_interest_common_4385.jsonl"),
                "--output_name",
                "strong_interest_common4385",
            ],
            "log_dir": logs_dir,
            "use_gpu": True,
        },
        {
            "name": "summarize_common4385",
            "deps": ["eval_base_raw", "eval_base_interest", "eval_strong_raw", "eval_strong_interest"],
            "ready_path": os.path.join(results_dir, "summary_common4385.json"),
            "cmd": [
                py,
                ...
                results_dir,
                "--output_path",
                os.path.join(results_dir, "summary_common4385.json"),
            ],
            "log_dir": logs_dir,
            "use_gpu": False,
        },
