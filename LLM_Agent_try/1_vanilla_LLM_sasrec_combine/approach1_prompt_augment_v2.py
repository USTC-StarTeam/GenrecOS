...
def get_sasrec_top_k(model, tokenizer, item_sequence, id_to_item, item_titles, k=20, max_seq_length=100):
    """
    ...
    """
    # Truncate sequence if too long (SASRec max_position_embeddings=101)
